@extends('layouts/app')
@section('title') Stafeta Muntilor - Clasament - Cunostinte Turistice @endsection
@section('content')
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <section id="auto-layout-columns" class="row">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('rankings.category.knowledge.pdf', [$stageid, $category->id]) }}" target="_blank" class="btn btn-outline-primary waves-effect waves-light"><i data-feather='download'></i> Export Clasament PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="table-bordered">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header"><h4 class="card-title">Clasament - Cunostinte Turistice - Categoria {{ $category->name }}</h4></div>
