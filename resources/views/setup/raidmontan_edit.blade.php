                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 stations-list">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <span class="station_type_name_pa0">Start -> PA 1</span>
                                                        </div>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group mb-2 input">
                                                                <input type="text" class="form-control" placeholder="" aria-label="" name="stations_finish" value="" aria-describedby="basic-addon2">
                                                                <span class="input-group-text" id="basic-addon2">minute</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                            ...
                                            <div class="row">
                                                <div class="col-12 stations-list2">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <span class="station_type_name_pfa0">PFA 1</span>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="input-group mb-2 station_type_insert">
                                                        ...
                                                        <div class="col-md-3">
                                                        <div class="col-sm-2"><a href="javascript:void(0);" class="add_button_pfa" title="Add field"><img src="/images/add-icon.png"/></a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 offset-md-4 pt-50">
                                                    ...
                                                    <button type="submit" class="js--setup-raid-montan-update btn btn-success mr-1 mb-1" data-id="{{ $category->id }}">Adauga</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
