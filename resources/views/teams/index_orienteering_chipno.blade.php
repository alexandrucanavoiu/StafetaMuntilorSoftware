                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Lista Echipe Orientare IMPORT din SPORTIDENT</h4>
                            </div>
                            <div class="card-body">
            ...
            <div class="row match-height">
                    ...
                    <div class="col-lg-6 col-12">
                                <div class="card">
                                    ...
                                    <br />
                                    <p><span class="badge rounded-pill badge-light-success me-1">VERDE</span> - Echipa a fost identificata in fisierul de import si a fost actualizata cu CHIPNO.</p>
                                    <p><span class="badge rounded-pill badge-light-warning me-1">GALBEN</span> - Echipa nu a fost actualizata cu CHIPNO - poate nu a participat la orientare, asa ca o sa fie abandon.</p>
                                    <p><span class="badge rounded-pill badge-light-danger me-1">ROSU</span> - Echipa din fisierul important nu se regaseste in baza de date pentru aceasta etapa, poate numele echipei sau categoria in programul SPORTIDENT este gresit.</p>
                                    </div>
                                </div>
                    </div>
            </div>
