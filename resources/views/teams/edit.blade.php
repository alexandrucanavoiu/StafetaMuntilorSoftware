<div class="modal fade" id="TeamsEdit" tabindex="-1" role="dialog" aria-labelledby="TeamsEdit" aria-hidden="true">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Editare echipa</h4>
                                <ol class="breadcrumb">
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control club_id" aria-required="true" id="club_id" name="club_id">
                                                                ...
                                                                @foreach($clubs as $club)
                                                                    <option value="{{ $club->id }}" {{ $club->id === $team->club_id ? 'selected' : '' }} >{{ $club->name }}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row name-list">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control name" id="name" type="text" name="name" placeholder="" value="{{ $team->name }}">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control category_id" aria-required="true" id="category_id" name="category_id">
                                                                ...
                                                                @foreach($categories as $category)
                                                                    <option value="{{ $category->id }}" {{ $category->id === $team->category_id ? 'selected' : '' }} >{{ $category->name }}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row number-list">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control number" id="number" type="text" name="number" placeholder="" value="{{ $team->number }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row chipno-list">
                                                        <div class="col-md-4">
                                                            <span>Chipno: </span>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <input class="form-control chipno" id="chipno" type="text" name="chipno" placeholder="" value="{{ $team->chipno }}">
                                                            <div class="help-block text-danger print-error" id="chipno-error" style="display:none"><ul role="alert"></ul></div>
                                                            <p><small class="text-muted">CHIPNO SPORTIDENT: 132322</small></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 offset-md-4 pt-50">
                                                    ...
                                                    <button type="submit" class="js--teams-update btn btn-success mr-1 mb-1" data-stageid="{{ $stageid }}" data-id="{{ $team->id }}">Update</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
