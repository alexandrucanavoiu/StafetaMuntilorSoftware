                ...
                <section>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Complete Team name from SPORTIDENT</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <form action="{{ route('import.teams_chipno_and_team_name_check', [$stageid]) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    <br />
