                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <button class="btn btn-outline-primary waves-effect waves-light js--clubs-create" data-stageid="{{ $stageid }}" data-toggle="modal"  data-target="#ClubsCreate"><span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus me-25"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Adauga un club nou</span></button>
                                    <a href="{{ route('clubs.clubs.listbyteams', [$stageid]) }}" class="btn btn-outline-primary waves-effect waves-light"><i data-feather='bar-chart-2'></i> Lista Cluburi in functie de echipe</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item js--clubs-edit" href="#" data-stageid="{{ $stageid }}" data-id="{{ $club->id }}" data-toggle="modal"  data-target="#ClubsEdit">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 me-50"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                                            <span>Edit</span>
                                                        </a>
                                                        <a class="dropdown-item js--clubs-destroy" href="#" data-stageid="{{ $stageid }}" data-id="{{ $club->id }}" data-toggle="modal"  data-target="#ClubsDestroy">
