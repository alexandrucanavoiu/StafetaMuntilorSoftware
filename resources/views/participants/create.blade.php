<div class="modal fade" id="ParticipantsCreate" tabindex="-1" role="dialog" aria-labelledby="ParticipantsCreate" aria-hidden="true">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 offset-md-4 pt-50">
                                                    ...
                                                    <button type="submit" class="js--participants-create-store btn btn-success mr-1 mb-1">Adauga</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
