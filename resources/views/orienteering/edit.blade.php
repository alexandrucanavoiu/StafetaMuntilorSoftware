                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 offset-md-4 pt-50">
                                                    ...
                                                    <button type="submit" class="js--orienteering-update btn btn-success mr-1 mb-1" data-stageid="{{ $stageid }}" data-categoryid="{{ $category->id }}" data-teamid="{{ $team->id }}">Adauga</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
