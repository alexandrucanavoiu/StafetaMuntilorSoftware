                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row scor-list">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control scor" id="scor" type="text" name="scor" placeholder="" value="{{ $scor }}" required>
                                                ...
                                                <div class="col-md-8 offset-md-4 pt-50">
                                                    ...
                                                    <button type="submit" class="js--cultural-update btn btn-success mr-1 mb-1" data-stageid="{{ $stageid }}" data-id="{{ $club->id }}">Adauga</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
