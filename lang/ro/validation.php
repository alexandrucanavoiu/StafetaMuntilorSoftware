...
return [
    ...
    */
    ...
    'attributes' => [
        'name_stage' => 'Nume Etapa',
        'name_organizer' => 'Nume Organizator',
        'stage_number' => 'Numarul Etapei',
        'stations_pa' => 'PA',
        'club_id' => 'Nume Club',
        'name' => 'Nume',
        'category_id' => 'Categorie',
        'number' => 'Numar',
        'uuid_card_orienteering_id' => 'UUID Orienteeting',
        'uuid_card_raid_id' => 'UUID Raid',
        'scor' => 'Punctaj',
        'time' => 'Timp',
        'wrong_answers' => 'Intrebari Gresite',
        'wrong_questions' => 'Intrebarile Gresite',
        'abandon' => 'Abandon/Status',
        'start_time' => 'Timp Start',
        'finish_time' => 'Timp Finish',
        'missed_posts' => 'Posturi Lipsa',
    ],
];